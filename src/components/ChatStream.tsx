...
import { Send, Sparkles, User, Bot, HelpCircle, Lock } from "lucide-react";
...
export const ChatStream: React.FC<ChatStreamProps> = ({
  ...
  return (
    <div id="chat-stream-container" className="flex flex-col h-full bg-white rounded-2xl border border-stone-200 overflow-hidden shadow-2xs">
      ...
      {/* Messages Scroll Area or Locked Notice */}
      {isLockedMasked ? (
        <div
          id="chat-locked-mask"
          className="flex-1 p-8 flex flex-col items-center justify-center text-center space-y-3 bg-stone-50/50"
        >
          ...
          <div>
            ...
            <p className="text-xs text-stone-500 mt-1 max-w-sm">
              The conversation transcript is hidden. Enter your PIN to reveal the transcript and continue the dialogue.
            </p>
          </div>
          {onRequestUnlock && (
            <button
              id="chat-unlock-view-btn"
              type="button"
